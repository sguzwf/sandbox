...
var request = require('superagent-bluebird');
...
var p = new Parser('https://raw.githubusercontent.com/CindyLinz/BYOHC-Workshop/master/workshop-2016.1.14.md');

console.log(p.getMarkdownFileContentAsString());
